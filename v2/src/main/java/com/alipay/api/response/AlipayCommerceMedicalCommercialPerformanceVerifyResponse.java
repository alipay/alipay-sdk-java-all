...
public class AlipayCommerceMedicalCommercialPerformanceVerifyResponse extends AlipayResponse {
	...
	private static final long serialVersionUID = 4595329336484228537L;
	...
	/** 
	 * out_biz_no为外部唯一业务号，在用户核销权益时外部机构生成并调用核销接口，该字段用于幂等
	 */
	@ApiField("out_biz_no")
	private String outBizNo;

	/** 
	 * out_product_id为商户侧的权益id，用户商户侧唯一标记一个商户权益id。
	 */
	@ApiField("out_product_id")
	private String outProductId;

	/** 
	 * verify_result表示核销状态，返回当前权益核销成功（SUCCESS）还是失败（FAIL）
	 */
