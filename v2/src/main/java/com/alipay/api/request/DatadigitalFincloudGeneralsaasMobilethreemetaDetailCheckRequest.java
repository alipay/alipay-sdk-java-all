...
public class DatadigitalFincloudGeneralsaasMobilethreemetaDetailCheckRequest implements AlipayRequest<DatadigitalFincloudGeneralsaasMobilethreemetaDetailCheckResponse> {
	...
	* 手机号三要素核验详版
	...
	public Class<DatadigitalFincloudGeneralsaasMobilethreemetaDetailCheckResponse> getResponseClass() {
		return DatadigitalFincloudGeneralsaasMobilethreemetaDetailCheckResponse.class;
	}
