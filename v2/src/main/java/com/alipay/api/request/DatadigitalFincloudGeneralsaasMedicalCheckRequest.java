...
import com.alipay.api.response.DatadigitalFincloudGeneralsaasMedicalCheckResponse;
...
public class DatadigitalFincloudGeneralsaasMedicalCheckRequest implements AlipayUploadRequest<DatadigitalFincloudGeneralsaasMedicalCheckResponse> {
	...
	* 大模型凭证分类提示词
	...
	public String getApiMethodName() {
		return "datadigital.fincloud.generalsaas.medical.check";
	}
	...
	public Class<DatadigitalFincloudGeneralsaasMedicalCheckResponse> getResponseClass() {
		return DatadigitalFincloudGeneralsaasMedicalCheckResponse.class;
	}
