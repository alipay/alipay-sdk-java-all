...
import com.alipay.api.response.ZhimaMerchantCreditserviceLogoUploadResponse;
...
public class ZhimaMerchantCreditserviceLogoUploadRequest implements AlipayUploadRequest<ZhimaMerchantCreditserviceLogoUploadResponse> {
	...
	* 商户logo图片的二进制字节流，文件大小不超过 60KB，图片尺寸大小需保证 80*80。
	...
	public Class<ZhimaMerchantCreditserviceLogoUploadResponse> getResponseClass() {
		return ZhimaMerchantCreditserviceLogoUploadResponse.class;
	}
