...
public class AlipayCommerceIotDeviceBindQueryRequest implements AlipayRequest<AlipayCommerceIotDeviceBindQueryResponse> {
	...
	* IoT设备-商家-店铺绑定查询
	...
	public Class<AlipayCommerceIotDeviceBindQueryResponse> getResponseClass() {
		return AlipayCommerceIotDeviceBindQueryResponse.class;
	}
