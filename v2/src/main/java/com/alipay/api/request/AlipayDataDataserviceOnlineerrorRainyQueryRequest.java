...
import com.alipay.api.response.AlipayDataDataserviceOnlineerrorRainyQueryResponse;
...
public class AlipayDataDataserviceOnlineerrorRainyQueryRequest implements AlipayRequest<AlipayDataDataserviceOnlineerrorRainyQueryResponse> {
	...
	* 线上问题回归测试验证02无参数
	...
	public Class<AlipayDataDataserviceOnlineerrorRainyQueryResponse> getResponseClass() {
		return AlipayDataDataserviceOnlineerrorRainyQueryResponse.class;
	}
