...
public class AlipayOpenMiniOrderDeliveryModifyRequest implements AlipayRequest<AlipayOpenMiniOrderDeliveryModifyResponse> {
	...
	* 履约状态变更接口
	...
	public Class<AlipayOpenMiniOrderDeliveryModifyResponse> getResponseClass() {
		return AlipayOpenMiniOrderDeliveryModifyResponse.class;
	}
