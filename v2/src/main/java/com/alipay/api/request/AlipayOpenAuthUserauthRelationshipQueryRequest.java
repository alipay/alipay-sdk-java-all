...
public class AlipayOpenAuthUserauthRelationshipQueryRequest implements AlipayRequest<AlipayOpenAuthUserauthRelationshipQueryResponse> {
	...
	* 用户授权关系查询
	...
	public Class<AlipayOpenAuthUserauthRelationshipQueryResponse> getResponseClass() {
		return AlipayOpenAuthUserauthRelationshipQueryResponse.class;
	}
