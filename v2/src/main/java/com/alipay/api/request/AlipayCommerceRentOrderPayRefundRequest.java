...
import com.alipay.api.response.AlipayCommerceRentOrderPayRefundResponse;
...
多次退，部分退的情况，退款结果查询可以使用租赁行业订单查询alipay.commerce.rent.order.query(租赁订单查询)或者alipay.trade.query(统一收单交易查询)
	...
	public String getApiMethodName() {
		return "alipay.commerce.rent.order.pay.refund";
	}
	...
	public Class<AlipayCommerceRentOrderPayRefundResponse> getResponseClass() {
		return AlipayCommerceRentOrderPayRefundResponse.class;
	}
