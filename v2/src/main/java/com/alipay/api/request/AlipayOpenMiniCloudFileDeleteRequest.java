...
import com.alipay.api.domain.AlipayOpenMiniCloudFileDeleteModel;
...
public class AlipayOpenMiniCloudFileDeleteRequest implements AlipayRequest<AlipayOpenMiniCloudFileDeleteResponse> {
	...
	* 云存储文件目录批量删除
	...
	public Class<AlipayOpenMiniCloudFileDeleteResponse> getResponseClass() {
		return AlipayOpenMiniCloudFileDeleteResponse.class;
	}
