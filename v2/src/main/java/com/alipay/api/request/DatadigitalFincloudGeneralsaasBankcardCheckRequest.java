...
public class DatadigitalFincloudGeneralsaasBankcardCheckRequest implements AlipayRequest<DatadigitalFincloudGeneralsaasBankcardCheckResponse> {
	...
	* 银行卡核验
	...
	public Class<DatadigitalFincloudGeneralsaasBankcardCheckResponse> getResponseClass() {
		return DatadigitalFincloudGeneralsaasBankcardCheckResponse.class;
	}
