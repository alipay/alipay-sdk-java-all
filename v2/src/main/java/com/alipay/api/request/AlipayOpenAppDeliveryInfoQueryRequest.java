...
import com.alipay.api.domain.AlipayOpenAppDeliveryInfoQueryModel;
...
public class AlipayOpenAppDeliveryInfoQueryRequest implements AlipayRequest<AlipayOpenAppDeliveryInfoQueryResponse> {
	...
	* 履约信息查询接口
	...
	public Class<AlipayOpenAppDeliveryInfoQueryResponse> getResponseClass() {
		return AlipayOpenAppDeliveryInfoQueryResponse.class;
	}
