...
public class AlipayMarketingActivityOrderCreateRequest implements AlipayRequest<AlipayMarketingActivityOrderCreateResponse> {
	...
	* 商家营销购买下单接口
	...
	public Class<AlipayMarketingActivityOrderCreateResponse> getResponseClass() {
		return AlipayMarketingActivityOrderCreateResponse.class;
	}
