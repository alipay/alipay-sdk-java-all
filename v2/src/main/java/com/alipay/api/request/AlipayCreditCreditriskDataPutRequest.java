...
import com.alipay.api.domain.AlipayCreditCreditriskDataPutModel;
...
public class AlipayCreditCreditriskDataPutRequest implements AlipayRequest<AlipayCreditCreditriskDataPutResponse> {
	...
	* 企业融资数据采集平台对外的数据提交接口
	...
	public Class<AlipayCreditCreditriskDataPutResponse> getResponseClass() {
		return AlipayCreditCreditriskDataPutResponse.class;
	}
