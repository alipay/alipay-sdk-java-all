...
import com.alipay.api.response.DatadigitalFincloudGeneralsaasDeepfakeDetectResponse;
...
public class DatadigitalFincloudGeneralsaasDeepfakeDetectRequest implements AlipayUploadRequest<DatadigitalFincloudGeneralsaasDeepfakeDetectResponse> {
	...
	* 客户业务单据号，请保证幂等性。
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("detect_mode", this.detectMode);
	...
	public Class<DatadigitalFincloudGeneralsaasDeepfakeDetectResponse> getResponseClass() {
		return DatadigitalFincloudGeneralsaasDeepfakeDetectResponse.class;
	}
