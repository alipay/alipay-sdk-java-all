...
public class AlipayEcoMycarParkingAgreementQueryRequest implements AlipayRequest<AlipayEcoMycarParkingAgreementQueryResponse> {
	...
	* 车牌代扣状态查询API
	...
	public Class<AlipayEcoMycarParkingAgreementQueryResponse> getResponseClass() {
		return AlipayEcoMycarParkingAgreementQueryResponse.class;
	}
