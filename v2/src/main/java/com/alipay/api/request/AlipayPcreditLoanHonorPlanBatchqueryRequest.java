...
public class AlipayPcreditLoanHonorPlanBatchqueryRequest implements AlipayRequest<AlipayPcreditLoanHonorPlanBatchqueryResponse> {
	...
	* 待还款计划列表查询
	...
	public String getApiMethodName() {
		return "alipay.pcredit.loan.honor.plan.batchquery";
	}
	...
	public Class<AlipayPcreditLoanHonorPlanBatchqueryResponse> getResponseClass() {
		return AlipayPcreditLoanHonorPlanBatchqueryResponse.class;
	}
