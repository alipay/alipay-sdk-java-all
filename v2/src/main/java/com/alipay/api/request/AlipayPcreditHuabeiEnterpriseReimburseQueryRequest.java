...
public class AlipayPcreditHuabeiEnterpriseReimburseQueryRequest implements AlipayRequest<AlipayPcreditHuabeiEnterpriseReimburseQueryResponse> {
	...
	* 企业单据数据导出查询
	...
	public Class<AlipayPcreditHuabeiEnterpriseReimburseQueryResponse> getResponseClass() {
		return AlipayPcreditHuabeiEnterpriseReimburseQueryResponse.class;
	}
