 ...
 */
public class AlipayCommerceMedicalIndustrydataInquirydoctorUploadRequest implements AlipayRequest<AlipayCommerceMedicalIndustrydataInquirydoctorUploadResponse> {
	...
	* 专家问诊医生数据同步接口
	...
	public Class<AlipayCommerceMedicalIndustrydataInquirydoctorUploadResponse> getResponseClass() {
		return AlipayCommerceMedicalIndustrydataInquirydoctorUploadResponse.class;
	}
