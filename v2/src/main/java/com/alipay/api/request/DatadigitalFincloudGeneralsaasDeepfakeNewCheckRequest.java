...
import com.alipay.api.response.DatadigitalFincloudGeneralsaasDeepfakeNewCheckResponse;
...
public class DatadigitalFincloudGeneralsaasDeepfakeNewCheckRequest implements AlipayUploadRequest<DatadigitalFincloudGeneralsaasDeepfakeNewCheckResponse> {
	...
	* 客户业务单据号，请保证幂等性。
	...
	public String getApiMethodName() {
		return "datadigital.fincloud.generalsaas.deepfake.new.check";
	}
	...
	public Class<DatadigitalFincloudGeneralsaasDeepfakeNewCheckResponse> getResponseClass() {
		return DatadigitalFincloudGeneralsaasDeepfakeNewCheckResponse.class;
	}
