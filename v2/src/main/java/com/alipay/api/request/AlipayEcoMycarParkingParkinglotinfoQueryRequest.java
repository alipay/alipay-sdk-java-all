...
public class AlipayEcoMycarParkingParkinglotinfoQueryRequest implements AlipayRequest<AlipayEcoMycarParkingParkinglotinfoQueryResponse> {
	...
	* 停车场信息查询
	...
	public Class<AlipayEcoMycarParkingParkinglotinfoQueryResponse> getResponseClass() {
		return AlipayEcoMycarParkingParkinglotinfoQueryResponse.class;
	}
