...
import com.alipay.api.domain.KoubeiQualityTestxxxBatchcreateModel;
import java.util.Map;

import com.alipay.api.AlipayRequest;
import com.alipay.api.internal.util.AlipayHashMap;
import com.alipay.api.response.KoubeiQualityTestxxxBatchcreateResponse;
...
public class KoubeiQualityTestxxxBatchcreateRequest implements AlipayRequest<KoubeiQualityTestxxxBatchcreateResponse> {
	...
	* koubei.quality.
	...
	public Class<KoubeiQualityTestxxxBatchcreateResponse> getResponseClass() {
		return KoubeiQualityTestxxxBatchcreateResponse.class;
	}
