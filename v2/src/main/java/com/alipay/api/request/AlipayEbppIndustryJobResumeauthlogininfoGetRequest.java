...
public class AlipayEbppIndustryJobResumeauthlogininfoGetRequest implements AlipayRequest<AlipayEbppIndustryJobResumeauthlogininfoGetResponse> {
	...
	* 通过bizToken获取用户简历授权登录信息
	...
	public String getApiMethodName() {
		return "alipay.ebpp.industry.job.resumeauthlogininfo.get";
	}
	...
	public Class<AlipayEbppIndustryJobResumeauthlogininfoGetResponse> getResponseClass() {
		return AlipayEbppIndustryJobResumeauthlogininfoGetResponse.class;
	}
