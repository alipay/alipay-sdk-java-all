...
public class AlipayOpenAuthAppauthInviteCreateRequest implements AlipayRequest<AlipayOpenAuthAppauthInviteCreateResponse> {
	...
	* ISV向商户发起应用授权邀约
	...
	public Class<AlipayOpenAuthAppauthInviteCreateResponse> getResponseClass() {
		return AlipayOpenAuthAppauthInviteCreateResponse.class;
	}
