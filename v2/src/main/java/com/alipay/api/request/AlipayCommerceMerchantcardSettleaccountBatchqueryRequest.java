...
import com.alipay.api.response.AlipayCommerceMerchantcardSettleaccountBatchqueryResponse;
...
public class AlipayCommerceMerchantcardSettleaccountBatchqueryRequest implements AlipayRequest<AlipayCommerceMerchantcardSettleaccountBatchqueryResponse> {
	...
	* 查看可配置的默认结算账户
	...
	public Class<AlipayCommerceMerchantcardSettleaccountBatchqueryResponse> getResponseClass() {
		return AlipayCommerceMerchantcardSettleaccountBatchqueryResponse.class;
	}
