...
public class AlipayCommerceEcEmployeeInfoQueryRequest implements AlipayRequest<AlipayCommerceEcEmployeeInfoQueryResponse> {
	...
	* 查询员工详情
	...
	public Class<AlipayCommerceEcEmployeeInfoQueryResponse> getResponseClass() {
		return AlipayCommerceEcEmployeeInfoQueryResponse.class;
	}
