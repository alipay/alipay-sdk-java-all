...
public class AlipayEbppInvoiceExpensecontrolIssuebatchCancelRequest implements AlipayRequest<AlipayEbppInvoiceExpensecontrolIssuebatchCancelResponse> {
	...
	* 作废额度发放
	...
	public Class<AlipayEbppInvoiceExpensecontrolIssuebatchCancelResponse> getResponseClass() {
		return AlipayEbppInvoiceExpensecontrolIssuebatchCancelResponse.class;
	}
