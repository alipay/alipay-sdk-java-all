...
import com.alipay.api.response.AlipayOpenSpCanteenOpenQueryResponse;
...
public class AlipayOpenSpCanteenOpenQueryRequest implements AlipayRequest<AlipayOpenSpCanteenOpenQueryResponse> {
	...
	* 查询商户点餐业务开通状态信息
	...
	public String getApiMethodName() {
		return "alipay.open.sp.canteen.open.query";
	}
	...
	public Class<AlipayOpenSpCanteenOpenQueryResponse> getResponseClass() {
		return AlipayOpenSpCanteenOpenQueryResponse.class;
	}
