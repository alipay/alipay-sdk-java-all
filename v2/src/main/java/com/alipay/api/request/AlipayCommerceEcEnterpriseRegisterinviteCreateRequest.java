...
public class AlipayCommerceEcEnterpriseRegisterinviteCreateRequest implements AlipayRequest<AlipayCommerceEcEnterpriseRegisterinviteCreateResponse> {
	...
	* 邀请企业注册
	...
	public Class<AlipayCommerceEcEnterpriseRegisterinviteCreateResponse> getResponseClass() {
		return AlipayCommerceEcEnterpriseRegisterinviteCreateResponse.class;
	}
