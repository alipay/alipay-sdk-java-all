...
import com.alipay.api.domain.AlipayMarketingImagedirectoryListQueryModel;
...
public class AlipayMarketingImagedirectoryListQueryRequest implements AlipayRequest<AlipayMarketingImagedirectoryListQueryResponse> {
	...
	* 目录分页查询接口
	...
	public Class<AlipayMarketingImagedirectoryListQueryResponse> getResponseClass() {
		return AlipayMarketingImagedirectoryListQueryResponse.class;
	}
