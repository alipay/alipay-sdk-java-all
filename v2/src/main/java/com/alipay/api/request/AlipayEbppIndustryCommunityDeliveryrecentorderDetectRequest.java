...
public class AlipayEbppIndustryCommunityDeliveryrecentorderDetectRequest implements AlipayRequest<AlipayEbppIndustryCommunityDeliveryrecentorderDetectResponse> {
	...
	* 骑手身份校验接口
	...
	public Class<AlipayEbppIndustryCommunityDeliveryrecentorderDetectResponse> getResponseClass() {
		return AlipayEbppIndustryCommunityDeliveryrecentorderDetectResponse.class;
	}
