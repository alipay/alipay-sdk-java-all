 ...
 *
 * @author auto create
 * @since 1.0, 2023-06-27 19:24:16
 */
public class AlipayOpenAppLocalitemCreateModel extends AlipayObject {

	private static final long serialVersionUID = 4167552424873171545L;
	...
	/**
	 * 商品主图
图片文件id，图片宽高为750px*750px，宽高比1:1。文件id通过alipay.open.file.upload接口上传资源获取，链接https://opendocs.alipay.com/mini/05snwo。
	 */
	@ApiField("head_img")
