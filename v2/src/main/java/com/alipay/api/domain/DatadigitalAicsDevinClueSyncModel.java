 ...
 */
public class DatadigitalAicsDevinClueSyncModel extends AlipayObject {

	private static final long serialVersionUID = 7546137478266693616L;
	...
	/**
	 * 租户ID,参数类型为字符串string类型,示例值："VTGhsiqj8791n"
	 */
	@ApiField("tenant_id")
