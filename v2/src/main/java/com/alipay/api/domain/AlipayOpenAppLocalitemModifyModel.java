 ...
 *
 * @author auto create
 * @since 1.0, 2024-01-18 14:49:51
 */
public class AlipayOpenAppLocalitemModifyModel extends AlipayObject {

	private static final long serialVersionUID = 1717563424163265442L;
	...
	/**
	 * 商品主图 图片文件id，图片宽高为750px*750px，宽高比1:1。文件id通过<a href="https://opendocs.alipay.com/mini/05snwo">alipay.open.file.upload接口</a>上传资源获取。
	 */
	@ApiField("head_img")
	private String headImg;

	/**
	 * 商品图片的文件id列表，不超过 3 个图片，用于商品主图的补充。图片支持jpg、jpeg、png格式，宽度及宽高比为 1:1 ，750px*750px。文件id通过<a href="https://opendocs.alipay.com/mini/05snwo">alipay.open.file.upload接口</a>上传资源获取。
	 */
