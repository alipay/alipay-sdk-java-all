...
public class ObfBillStandardAcceptanceRequest extends AlipayObject {
	 ...
	 * 标准事件类型
	 */
	@ApiField("standard_event_type")
	private String standardEventType;
	...
	public String getStandardEventType() {
		return this.standardEventType;
	}
	public void setStandardEventType(String standardEventType) {
