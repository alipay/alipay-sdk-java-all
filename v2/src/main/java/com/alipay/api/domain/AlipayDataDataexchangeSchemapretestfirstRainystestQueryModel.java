 ...
 */
public class AlipayDataDataexchangeSchemapretestfirstRainystestQueryModel extends AlipayObject {

	private static final long serialVersionUID = 6478493849283461642L;
	 ...
	 * null
	 */
	@ApiListField("demo_date")
	@ApiField("rainy_a_a_a")
	private List<RainyAAA> demoDate;
	...
	public List<RainyAAA> getDemoDate() {
		return this.demoDate;
	}
	public void setDemoDate(List<RainyAAA> demoDate) {
