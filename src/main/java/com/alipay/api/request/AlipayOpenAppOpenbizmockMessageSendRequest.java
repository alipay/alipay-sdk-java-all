 ...
 */
public class AlipayOpenAppOpenbizmockMessageSendRequest implements AlipayRequest<AlipayOpenAppOpenbizmockMessageSendResponse> {
	...
	*  模拟业务系统上行消息接口
	...
	public Class<AlipayOpenAppOpenbizmockMessageSendResponse> getResponseClass() {
		return AlipayOpenAppOpenbizmockMessageSendResponse.class;
	}
