 ...
 */
public class ZhimaCreditEpSceneAgreementUseRequest implements AlipayRequest<ZhimaCreditEpSceneAgreementUseResponse> {
	...
	* 加入信用服务
	...
	public Class<ZhimaCreditEpSceneAgreementUseResponse> getResponseClass() {
		return ZhimaCreditEpSceneAgreementUseResponse.class;
	}
