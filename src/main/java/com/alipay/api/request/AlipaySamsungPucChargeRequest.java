...
import com.alipay.api.response.AlipaySamsungPucChargeResponse;
...
public class AlipaySamsungPucChargeRequest implements AlipayRequest<AlipaySamsungPucChargeResponse> {
	...
	* wifi上的mac地址
	...
	public Class<AlipaySamsungPucChargeResponse> getResponseClass() {
		return AlipaySamsungPucChargeResponse.class;
	}
