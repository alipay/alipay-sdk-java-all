...
import com.alipay.api.domain.AlipayMerchantIndirectAuthorderQuerystatusModel;
...
public class AlipayMerchantIndirectAuthorderQuerystatusRequest implements AlipayRequest<AlipayMerchantIndirectAuthorderQuerystatusResponse> {
	...
	* 查询意愿申请单审核结果
	...
	public Class<AlipayMerchantIndirectAuthorderQuerystatusResponse> getResponseClass() {
		return AlipayMerchantIndirectAuthorderQuerystatusResponse.class;
	}
