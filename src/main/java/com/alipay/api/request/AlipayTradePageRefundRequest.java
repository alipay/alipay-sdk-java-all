 ...
 */
public class AlipayTradePageRefundRequest implements AlipayRequest<AlipayTradePageRefundResponse> {
	...
	* 统一收单退款页面接口
	...
	public Class<AlipayTradePageRefundResponse> getResponseClass() {
		return AlipayTradePageRefundResponse.class;
	}
