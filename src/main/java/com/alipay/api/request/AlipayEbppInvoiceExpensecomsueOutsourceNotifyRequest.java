...
public class AlipayEbppInvoiceExpensecomsueOutsourceNotifyRequest implements AlipayRequest<AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponse> {
	...
	* 外部员工消费通知
	...
	public Class<AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponse> getResponseClass() {
		return AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponse.class;
	}
