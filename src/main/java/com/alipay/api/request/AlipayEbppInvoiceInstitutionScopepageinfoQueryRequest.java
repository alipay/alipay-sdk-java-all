...
public class AlipayEbppInvoiceInstitutionScopepageinfoQueryRequest implements AlipayRequest<AlipayEbppInvoiceInstitutionScopepageinfoQueryResponse> {
	...
	* 分页查询制度下人员
	...
	public Class<AlipayEbppInvoiceInstitutionScopepageinfoQueryResponse> getResponseClass() {
		return AlipayEbppInvoiceInstitutionScopepageinfoQueryResponse.class;
	}
