...
import com.alipay.api.domain.AlipayMerchantIndirectAuthorderCreateModel;
...
public class AlipayMerchantIndirectAuthorderCreateRequest implements AlipayRequest<AlipayMerchantIndirectAuthorderCreateResponse> {
	...
	* 间连商户意愿确认申请单提交
	...
	public Class<AlipayMerchantIndirectAuthorderCreateResponse> getResponseClass() {
		return AlipayMerchantIndirectAuthorderCreateResponse.class;
	}
