...
import com.alipay.api.response.AlipayCommerceAirXfgDsgModifyResponse;
...
public class AlipayCommerceAirXfgDsgModifyRequest implements AlipayRequest<AlipayCommerceAirXfgDsgModifyResponse> {
	...
	* 吃饭更好
	...
	public Class<AlipayCommerceAirXfgDsgModifyResponse> getResponseClass() {
		return AlipayCommerceAirXfgDsgModifyResponse.class;
	}
