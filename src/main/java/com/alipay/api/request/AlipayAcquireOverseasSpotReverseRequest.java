...
import com.alipay.api.response.AlipayAcquireOverseasSpotReverseResponse;
 ...
 */
public class AlipayAcquireOverseasSpotReverseRequest implements AlipayRequest<AlipayAcquireOverseasSpotReverseResponse> {
	...
	* The original partner transaction id given in the payment request
	...
	public Class<AlipayAcquireOverseasSpotReverseResponse> getResponseClass() {
		return AlipayAcquireOverseasSpotReverseResponse.class;
	}
