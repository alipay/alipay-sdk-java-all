...
import com.alipay.api.domain.AftAifinFireeyeOcrImageQueryModel;
...
public class AftAifinFireeyeOcrImageQueryRequest implements AlipayRequest<AftAifinFireeyeOcrImageQueryResponse> {
	...
	* OCR火眼识别
	...
	public Class<AftAifinFireeyeOcrImageQueryResponse> getResponseClass() {
		return AftAifinFireeyeOcrImageQueryResponse.class;
	}
