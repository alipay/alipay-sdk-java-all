...
import com.alipay.api.response.AlipayBossProdManjiangdstestStopResponse;
...
public class AlipayBossProdManjiangdstestStopRequest implements AlipayRequest<AlipayBossProdManjiangdstestStopResponse> {
	...
	* 1
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("sss", this.sss);
		txtParams.put("sss_openid", this.sssOpenid);
		if(udfParams != null) {
	...
	public Class<AlipayBossProdManjiangdstestStopResponse> getResponseClass() {
		return AlipayBossProdManjiangdstestStopResponse.class;
	}
