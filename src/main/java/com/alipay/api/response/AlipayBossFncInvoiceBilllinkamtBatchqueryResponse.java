...
/**
 * ALIPAY API: alipay.boss.fnc.invoice.billlinkamt.batchquery response.
 * 
 * @author auto create
 * @since 1.0, 2019-10-25 14:09:19
 */
public class AlipayBossFncInvoiceBilllinkamtBatchqueryResponse extends AlipayResponse {

	private static final long serialVersionUID = 5828776727283944231L;
