...
/**
 * ALIPAY API: alipay.user.provisioningbundle.create response.
 * 
 * @author auto create
 * @since 1.0, 2019-11-20 15:54:26
 */
public class AlipayUserProvisioningbundleCreateResponse extends AlipayResponse {

	private static final long serialVersionUID = 6712854913654399263L;
