 ...
 *
 * @author auto create
 * @since 1.0, 2022-03-01 11:00:22
 */
public class AlipayTradeCreateModel extends AlipayObject {

	private static final long serialVersionUID = 2652819164977712458L;
...
注：交易的买家与卖家不能相同。
	...
	/**
	 * 买家支付宝登录账号。
buyer_logon_id和buyer_id两者传其一，和buyer_id不能同时为空，建议通过buyer_id来传递买家信息。
	 */
