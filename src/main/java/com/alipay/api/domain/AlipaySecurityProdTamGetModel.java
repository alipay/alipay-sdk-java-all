 ...
 *
 * @author auto create
 * @since 1.0, 2019-11-20 17:10:53
 */
public class AlipaySecurityProdTamGetModel extends AlipayObject {

	private static final long serialVersionUID = 2157612983473954127L;
	...
	/**
	 * condition客户端状态信息，记录如客户端的机型等信息的字段+不唯一+由客户端上传给支付宝，支付宝服务端，再转发给OEM厂商服务端，OEM厂商服务端请求ta的时候带上这个字段信息+特殊说明：仅传递机型信息，用于问题排查以及分析。
	 */
	@ApiField("condition")
