 ...
 *
 * @author auto create
 * @since 1.0, 2017-09-15 16:48:34
 */
public class KoubeiItemExtitemInfoModifyModel extends AlipayObject {

	private static final long serialVersionUID = 3326628955241621296L;

	/**
	 * 品牌信息（目前支持3级品牌）多级品牌，全量修改，不支持仅修改某一级品类
	 */
	...
	/**
	 * 品类列表信息（目前支持5级品类）  注：多级品类，全量修改，不支持仅修改某一级品类
	 */
	...
	/**
	 * 币种，表示该商品售价，对应的货币种类：人民币／美元／英镑  等
	 */
	@ApiField("currency")
