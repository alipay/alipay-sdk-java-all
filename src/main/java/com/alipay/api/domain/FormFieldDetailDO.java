 ...
 *
 * @author auto create
 * @since 1.0, 2017-10-23 13:51:12
 */
public class FormFieldDetailDO extends AlipayObject {

	private static final long serialVersionUID = 5516899721638386137L;

	/**
	 * common_fields属性定义一个表单通用字段数组，字段有效值如下列表所示：
