 ...
 *
 * @author auto create
 * @since 1.0, 2018-03-30 17:31:56
 */
public class KoubeiMarketingThirdpartyActivityCreateModel extends AlipayObject {

	private static final long serialVersionUID = 8463579463785347471L;
...
POINT_SEND：集点卡活动
	...
	public PromoTool getPromoTools() {
		return this.promoTools;
	}
	public void setPromoTools(PromoTool promoTools) {
		this.promoTools = promoTools;
	}

	public PublishChannel getPublishChannels() {
		return this.publishChannels;
	}
	public void setPublishChannels(PublishChannel publishChannels) {
