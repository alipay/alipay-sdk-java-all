...
| [**delete**](AntMerchantExpandItemApi.md#delete) | **POST** /v3/ant/merchant/expand/item/delete | 商品删除接口 |
| [**modify**](AntMerchantExpandItemApi.md#modify) | **POST** /v3/ant/merchant/expand/item/modify | 商品修改接口 |
| [**query**](AntMerchantExpandItemApi.md#query) | **POST** /v3/ant/merchant/expand/item/query | 商品查询接口 |


<a name="create"></a>
# **create**
> AntMerchantExpandItemCreateResponseModel create()
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AntMerchantExpandItemCreateResponseModel result = apiInstance.create();
...
<a name="delete"></a>
# **delete**
> AntMerchantExpandItemDeleteResponseModel delete()
...
public class Example {
  public static void main(String[] args) {
    ...
    AntMerchantExpandItemApi apiInstance = new AntMerchantExpandItemApi(defaultClient);
    try {
      AntMerchantExpandItemDeleteResponseModel result = apiInstance.delete();
      System.out.println(result);
    } catch (ApiException e) {
...
<a name="modify"></a>
# **modify**
> AntMerchantExpandItemModifyResponseModel modify()
...
public class Example {
  public static void main(String[] args) {
    ...
    AntMerchantExpandItemApi apiInstance = new AntMerchantExpandItemApi(defaultClient);
    try {
      AntMerchantExpandItemModifyResponseModel result = apiInstance.modify();
      System.out.println(result);
    } catch (ApiException e) {
...
<a name="query"></a>
# **query**
> AntMerchantExpandItemQueryResponseModel query()
...
public class Example {
  public static void main(String[] args) {
    ...
    AntMerchantExpandItemApi apiInstance = new AntMerchantExpandItemApi(defaultClient);
    try {
      AntMerchantExpandItemQueryResponseModel result = apiInstance.query();
      System.out.println(result);
    } catch (ApiException e) {
