...
public class AlipayPassInstanceUpdateDefaultResponse extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AlipayPassInstanceUpdateDefaultResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AlipayPassInstanceUpdateDefaultResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AlipayPassInstanceUpdateErrorResponseModel> adapterAlipayPassInstanceUpdateErrorResponseModel = gson.getDelegateAdapter(this, TypeToken.get(AlipayPassInstanceUpdateErrorResponseModel.class));
            final TypeAdapter<CommonErrorType> adapterCommonErrorType = gson.getDelegateAdapter(this, TypeToken.get(CommonErrorType.class));

            return (TypeAdapter<T>) new TypeAdapter<AlipayPassInstanceUpdateDefaultResponse>() {
                @Override
                public void write(JsonWriter out, AlipayPassInstanceUpdateDefaultResponse value) throws IOException {
                    ...
                    // check if the actual instance is of the type `AlipayPassInstanceUpdateErrorResponseModel`
                    if (value.getActualInstance() instanceof AlipayPassInstanceUpdateErrorResponseModel) {
                        JsonObject obj = adapterAlipayPassInstanceUpdateErrorResponseModel.toJsonTree((AlipayPassInstanceUpdateErrorResponseModel)value.getActualInstance()).getAsJsonObject();
                ...
                public AlipayPassInstanceUpdateDefaultResponse read(JsonReader in) throws IOException {
                    ...
                    // deserialize AlipayPassInstanceUpdateErrorResponseModel
                    try {
                        ...
                        ret.setActualInstance(adapterAlipayPassInstanceUpdateErrorResponseModel.fromJsonTree(jsonObject));
                        return ret;
                    } catch (Exception e) {
    ...
    static {
        schemas.put("AlipayPassInstanceUpdateErrorResponseModel", new GenericType<AlipayPassInstanceUpdateErrorResponseModel>() {
        });
    ...
    public Map<String, GenericType> getSchemas() {
        return AlipayPassInstanceUpdateDefaultResponse.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * AlipayPassInstanceUpdateErrorResponseModel, CommonErrorType
     *
     ...
     * AlipayPassInstanceUpdateErrorResponseModel, CommonErrorType
     *
     * @return The actual instance (AlipayPassInstanceUpdateErrorResponseModel, CommonErrorType)
     */
    @Override
    ...
    /**
     * Get the actual instance of `AlipayPassInstanceUpdateErrorResponseModel`. If the actual instance is not `AlipayPassInstanceUpdateErrorResponseModel`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AlipayPassInstanceUpdateErrorResponseModel`
     * @throws ClassCastException if the instance is not `AlipayPassInstanceUpdateErrorResponseModel`
     */
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlipayPassInstanceUpdateDefaultResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    // validate anyOf schemas one by one
    int validCount = 0;
    // validate the json string with AlipayPassInstanceUpdateErrorResponseModel
    try {
 ...
 /**
  * Create an instance of AlipayPassInstanceUpdateDefaultResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AlipayPassInstanceUpdateDefaultResponse
  * @throws IOException if the JSON string is invalid with respect to AlipayPassInstanceUpdateDefaultResponse
  */
  public static AlipayPassInstanceUpdateDefaultResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlipayPassInstanceUpdateDefaultResponse.class);
  }

 /**
  * Convert an instance of AlipayPassInstanceUpdateDefaultResponse to an JSON string
  *
  * @return JSON string
  */
