...
public class AlipayCommerceEcEmployeeInfoApi {
     ...
     */
    public okhttp3.Call queryCall(String enterpriseId, String employeeId, String openId, String userId, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String enterpriseId, String employeeId, String openId, String userId, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(enterpriseId, employeeId, openId, userId, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayCommerceEcEmployeeInfoQueryResponseModel query(String enterpriseId, String employeeId, String openId, String userId) throws ApiException {
        ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> localVarResp = queryWithHttpInfo(enterpriseId, employeeId, openId, userId, null);
        return localVarResp.getData();
    }

    public AlipayCommerceEcEmployeeInfoQueryResponseModel query(String enterpriseId, String employeeId, String openId, String userId, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> localVarResp = queryWithHttpInfo(enterpriseId, employeeId, openId, userId, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> queryWithHttpInfo(String enterpriseId, String employeeId, String openId, String userId, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, employeeId, openId, userId, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(String enterpriseId, String employeeId, String openId, String userId, final ApiCallback<AlipayCommerceEcEmployeeInfoQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, employeeId, openId, userId, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayCommerceEcEmployeeInfoQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(String enterpriseId, String employeeId, String openId, String userId, final ApiCallback<AlipayCommerceEcEmployeeInfoQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, employeeId, openId, userId, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayCommerceEcEmployeeInfoQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
