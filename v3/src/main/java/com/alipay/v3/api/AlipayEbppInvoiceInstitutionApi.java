...
public class AlipayEbppInvoiceInstitutionApi {
     ...
     * @param accountId 企业共同账户id（条件必填） (optional)
     * @param agreementNo 授权签约协议号（条件必填） (optional)
     * @param enterpriseId 企业id（条件必填） (optional)
     ...
     */
    public Object delete(String accountId, String agreementNo, String enterpriseId, String institutionId) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(accountId, agreementNo, enterpriseId, institutionId, null);
        return localVarResp.getData();
    }

    public Object delete(String accountId, String agreementNo, String enterpriseId, String institutionId, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(accountId, agreementNo, enterpriseId, institutionId, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteWithHttpInfo(String accountId, String agreementNo, String enterpriseId, String institutionId, CustomizedParams customizedParams) throws ApiException {
     ...
     */
    public okhttp3.Call deleteAsync(String accountId, String agreementNo, String enterpriseId, String institutionId, final ApiCallback<Object> _callback) throws ApiException {
    ...
    public okhttp3.Call deleteAsync(String accountId, String agreementNo, String enterpriseId, String institutionId, final ApiCallback<Object> _callback, CustomizedParams customizedParams) throws ApiException {
     ...
     */
    public Object modify(AlipayEbppInvoiceInstitutionModifyModel alipayEbppInvoiceInstitutionModifyModel) throws ApiException {
        ApiResponse<Object> localVarResp = modifyWithHttpInfo(alipayEbppInvoiceInstitutionModifyModel, null);
        return localVarResp.getData();
    }

    public Object modify(AlipayEbppInvoiceInstitutionModifyModel alipayEbppInvoiceInstitutionModifyModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<Object> localVarResp = modifyWithHttpInfo(alipayEbppInvoiceInstitutionModifyModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> modifyWithHttpInfo(AlipayEbppInvoiceInstitutionModifyModel alipayEbppInvoiceInstitutionModifyModel, CustomizedParams customizedParams) throws ApiException {
     ...
     */
    public okhttp3.Call modifyAsync(AlipayEbppInvoiceInstitutionModifyModel alipayEbppInvoiceInstitutionModifyModel, final ApiCallback<Object> _callback) throws ApiException {
    ...
    public okhttp3.Call modifyAsync(AlipayEbppInvoiceInstitutionModifyModel alipayEbppInvoiceInstitutionModifyModel, final ApiCallback<Object> _callback, CustomizedParams customizedParams) throws ApiException {
