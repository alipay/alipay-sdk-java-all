...
import com.alipay.v3.model.AntMerchantExpandApprecommendAccountDeleteModel;
...
public class AntMerchantExpandApprecommendAccountApi {
     ...
     * @param antMerchantExpandApprecommendAccountDeleteModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call deleteCall(AntMerchantExpandApprecommendAccountDeleteModel antMerchantExpandApprecommendAccountDeleteModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : antMerchantExpandApprecommendAccountDeleteModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteValidateBeforeCall(AntMerchantExpandApprecommendAccountDeleteModel antMerchantExpandApprecommendAccountDeleteModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = deleteCall(antMerchantExpandApprecommendAccountDeleteModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public Object delete(AntMerchantExpandApprecommendAccountDeleteModel antMerchantExpandApprecommendAccountDeleteModel) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(antMerchantExpandApprecommendAccountDeleteModel, null);
        return localVarResp.getData();
    }

    public Object delete(AntMerchantExpandApprecommendAccountDeleteModel antMerchantExpandApprecommendAccountDeleteModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(antMerchantExpandApprecommendAccountDeleteModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteWithHttpInfo(AntMerchantExpandApprecommendAccountDeleteModel antMerchantExpandApprecommendAccountDeleteModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = deleteValidateBeforeCall(antMerchantExpandApprecommendAccountDeleteModel, null, customizedParams);
        try {
            Type localVarReturnType = new TypeToken<Object>(){}.getType();
            return localVarApiClient.execute(localVarCall, localVarReturnType);
        } catch (ApiException e) {
     ...
     */
    public okhttp3.Call deleteAsync(AntMerchantExpandApprecommendAccountDeleteModel antMerchantExpandApprecommendAccountDeleteModel, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(antMerchantExpandApprecommendAccountDeleteModel, _callback, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call deleteAsync(AntMerchantExpandApprecommendAccountDeleteModel antMerchantExpandApprecommendAccountDeleteModel, final ApiCallback<Object> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(antMerchantExpandApprecommendAccountDeleteModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
