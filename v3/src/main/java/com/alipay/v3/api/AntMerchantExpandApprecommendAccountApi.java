...
import com.alipay.v3.model.AntMerchantExpandApprecommendAccountQueryModel;
...
public class AntMerchantExpandApprecommendAccountApi {
     ...
     * @param antMerchantExpandApprecommendAccountQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(AntMerchantExpandApprecommendAccountQueryModel antMerchantExpandApprecommendAccountQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : antMerchantExpandApprecommendAccountQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(AntMerchantExpandApprecommendAccountQueryModel antMerchantExpandApprecommendAccountQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(antMerchantExpandApprecommendAccountQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AntMerchantExpandApprecommendAccountQueryResponseModel query(AntMerchantExpandApprecommendAccountQueryModel antMerchantExpandApprecommendAccountQueryModel) throws ApiException {
        ApiResponse<AntMerchantExpandApprecommendAccountQueryResponseModel> localVarResp = queryWithHttpInfo(antMerchantExpandApprecommendAccountQueryModel, null);
        return localVarResp.getData();
    }

    public AntMerchantExpandApprecommendAccountQueryResponseModel query(AntMerchantExpandApprecommendAccountQueryModel antMerchantExpandApprecommendAccountQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AntMerchantExpandApprecommendAccountQueryResponseModel> localVarResp = queryWithHttpInfo(antMerchantExpandApprecommendAccountQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AntMerchantExpandApprecommendAccountQueryResponseModel> queryWithHttpInfo(AntMerchantExpandApprecommendAccountQueryModel antMerchantExpandApprecommendAccountQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(antMerchantExpandApprecommendAccountQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(AntMerchantExpandApprecommendAccountQueryModel antMerchantExpandApprecommendAccountQueryModel, final ApiCallback<AntMerchantExpandApprecommendAccountQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(antMerchantExpandApprecommendAccountQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AntMerchantExpandApprecommendAccountQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(AntMerchantExpandApprecommendAccountQueryModel antMerchantExpandApprecommendAccountQueryModel, final ApiCallback<AntMerchantExpandApprecommendAccountQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(antMerchantExpandApprecommendAccountQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AntMerchantExpandApprecommendAccountQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
