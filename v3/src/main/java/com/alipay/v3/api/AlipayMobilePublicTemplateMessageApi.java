...
import com.alipay.v3.model.AlipayMobilePublicTemplateMessageGetModel;
...
public class AlipayMobilePublicTemplateMessageApi {
    ...
    /**
     * Build call for get
     * @param alipayMobilePublicTemplateMessageGetModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getCall(AlipayMobilePublicTemplateMessageGetModel alipayMobilePublicTemplateMessageGetModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayMobilePublicTemplateMessageGetModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValidateBeforeCall(AlipayMobilePublicTemplateMessageGetModel alipayMobilePublicTemplateMessageGetModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = getCall(alipayMobilePublicTemplateMessageGetModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayMobilePublicTemplateMessageGetResponseModel get(AlipayMobilePublicTemplateMessageGetModel alipayMobilePublicTemplateMessageGetModel) throws ApiException {
        ApiResponse<AlipayMobilePublicTemplateMessageGetResponseModel> localVarResp = getWithHttpInfo(alipayMobilePublicTemplateMessageGetModel, null);
        return localVarResp.getData();
    }

    public AlipayMobilePublicTemplateMessageGetResponseModel get(AlipayMobilePublicTemplateMessageGetModel alipayMobilePublicTemplateMessageGetModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayMobilePublicTemplateMessageGetResponseModel> localVarResp = getWithHttpInfo(alipayMobilePublicTemplateMessageGetModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayMobilePublicTemplateMessageGetResponseModel> getWithHttpInfo(AlipayMobilePublicTemplateMessageGetModel alipayMobilePublicTemplateMessageGetModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(alipayMobilePublicTemplateMessageGetModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call getAsync(AlipayMobilePublicTemplateMessageGetModel alipayMobilePublicTemplateMessageGetModel, final ApiCallback<AlipayMobilePublicTemplateMessageGetResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValidateBeforeCall(alipayMobilePublicTemplateMessageGetModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayMobilePublicTemplateMessageGetResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call getAsync(AlipayMobilePublicTemplateMessageGetModel alipayMobilePublicTemplateMessageGetModel, final ApiCallback<AlipayMobilePublicTemplateMessageGetResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = getValidateBeforeCall(alipayMobilePublicTemplateMessageGetModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayMobilePublicTemplateMessageGetResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
