...
public class AntMerchantExpandShopApi {
     ...
     * @param shopId 蚂蚁店铺id。填写本参数的话，store_id和ip_role_id可以不填 (optional)
     * @param storeId 门店编号，表示该门店在该商户角色id(直连pid，间连smid)下，由商户自己定义的外部门店编号。关店接口中，如果没传shop_id，则本字段与ip_role_id均必填 (optional)
     * @param ipRoleId 商户角色id，表示将要开的店属于哪个商户角色。对于直连开店场景，填写商户pid；对于间连开店场景（线上、线下、直付通），填写商户smid。本接口中，如果没传shop_id，则本字段与store_id均必填 (optional)
     ...
     */
    public okhttp3.Call queryCall(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(shopId, storeId, ipRoleId, addressVersion, needRecommend, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AntMerchantExpandShopQueryResponseModel query(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend) throws ApiException {
        ApiResponse<AntMerchantExpandShopQueryResponseModel> localVarResp = queryWithHttpInfo(shopId, storeId, ipRoleId, addressVersion, needRecommend, null);
        return localVarResp.getData();
    }

    public AntMerchantExpandShopQueryResponseModel query(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AntMerchantExpandShopQueryResponseModel> localVarResp = queryWithHttpInfo(shopId, storeId, ipRoleId, addressVersion, needRecommend, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AntMerchantExpandShopQueryResponseModel> queryWithHttpInfo(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(shopId, storeId, ipRoleId, addressVersion, needRecommend, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, final ApiCallback<AntMerchantExpandShopQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(shopId, storeId, ipRoleId, addressVersion, needRecommend, _callback, null);
        Type localVarReturnType = new TypeToken<AntMerchantExpandShopQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, final ApiCallback<AntMerchantExpandShopQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(shopId, storeId, ipRoleId, addressVersion, needRecommend, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AntMerchantExpandShopQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
