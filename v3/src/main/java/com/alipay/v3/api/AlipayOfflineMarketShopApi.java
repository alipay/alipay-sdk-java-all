...
import com.alipay.v3.model.AlipayOfflineMarketShopQuerydetailModel;
...
public class AlipayOfflineMarketShopApi {
     ...
     * @param alipayOfflineMarketShopQuerydetailModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call querydetailCall(AlipayOfflineMarketShopQuerydetailModel alipayOfflineMarketShopQuerydetailModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayOfflineMarketShopQuerydetailModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call querydetailValidateBeforeCall(AlipayOfflineMarketShopQuerydetailModel alipayOfflineMarketShopQuerydetailModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = querydetailCall(alipayOfflineMarketShopQuerydetailModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayOfflineMarketShopQuerydetailResponseModel querydetail(AlipayOfflineMarketShopQuerydetailModel alipayOfflineMarketShopQuerydetailModel) throws ApiException {
        ApiResponse<AlipayOfflineMarketShopQuerydetailResponseModel> localVarResp = querydetailWithHttpInfo(alipayOfflineMarketShopQuerydetailModel, null);
        return localVarResp.getData();
    }

    public AlipayOfflineMarketShopQuerydetailResponseModel querydetail(AlipayOfflineMarketShopQuerydetailModel alipayOfflineMarketShopQuerydetailModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayOfflineMarketShopQuerydetailResponseModel> localVarResp = querydetailWithHttpInfo(alipayOfflineMarketShopQuerydetailModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayOfflineMarketShopQuerydetailResponseModel> querydetailWithHttpInfo(AlipayOfflineMarketShopQuerydetailModel alipayOfflineMarketShopQuerydetailModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = querydetailValidateBeforeCall(alipayOfflineMarketShopQuerydetailModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call querydetailAsync(AlipayOfflineMarketShopQuerydetailModel alipayOfflineMarketShopQuerydetailModel, final ApiCallback<AlipayOfflineMarketShopQuerydetailResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = querydetailValidateBeforeCall(alipayOfflineMarketShopQuerydetailModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayOfflineMarketShopQuerydetailResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call querydetailAsync(AlipayOfflineMarketShopQuerydetailModel alipayOfflineMarketShopQuerydetailModel, final ApiCallback<AlipayOfflineMarketShopQuerydetailResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = querydetailValidateBeforeCall(alipayOfflineMarketShopQuerydetailModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayOfflineMarketShopQuerydetailResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
