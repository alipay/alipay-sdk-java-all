...
public class AlipayOpenPublicLifeMsgApi {
     ...
     */
    public okhttp3.Call recallCall(final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
    ...
    private okhttp3.Call recallValidateBeforeCall(final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = recallCall(_callback, customizedParams);
        return localVarCall;
     ...
     */
    public Object recall() throws ApiException {
        ApiResponse<Object> localVarResp = recallWithHttpInfo(null);
        return localVarResp.getData();
    }

    public Object recall(CustomizedParams customizedParams) throws ApiException {
        ApiResponse<Object> localVarResp = recallWithHttpInfo(customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> recallWithHttpInfo(CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = recallValidateBeforeCall(null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call recallAsync(final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = recallValidateBeforeCall(_callback, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call recallAsync(final ApiCallback<Object> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = recallValidateBeforeCall(_callback, customizedParams);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
