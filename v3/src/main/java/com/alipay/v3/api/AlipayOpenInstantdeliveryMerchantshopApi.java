...
import com.alipay.v3.model.AlipayOpenInstantdeliveryMerchantshopQueryModel;
...
public class AlipayOpenInstantdeliveryMerchantshopApi {
     ...
     * @param alipayOpenInstantdeliveryMerchantshopQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(AlipayOpenInstantdeliveryMerchantshopQueryModel alipayOpenInstantdeliveryMerchantshopQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayOpenInstantdeliveryMerchantshopQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(AlipayOpenInstantdeliveryMerchantshopQueryModel alipayOpenInstantdeliveryMerchantshopQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(alipayOpenInstantdeliveryMerchantshopQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayOpenInstantdeliveryMerchantshopQueryResponseModel query(AlipayOpenInstantdeliveryMerchantshopQueryModel alipayOpenInstantdeliveryMerchantshopQueryModel) throws ApiException {
        ApiResponse<AlipayOpenInstantdeliveryMerchantshopQueryResponseModel> localVarResp = queryWithHttpInfo(alipayOpenInstantdeliveryMerchantshopQueryModel, null);
        return localVarResp.getData();
    }

    public AlipayOpenInstantdeliveryMerchantshopQueryResponseModel query(AlipayOpenInstantdeliveryMerchantshopQueryModel alipayOpenInstantdeliveryMerchantshopQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayOpenInstantdeliveryMerchantshopQueryResponseModel> localVarResp = queryWithHttpInfo(alipayOpenInstantdeliveryMerchantshopQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayOpenInstantdeliveryMerchantshopQueryResponseModel> queryWithHttpInfo(AlipayOpenInstantdeliveryMerchantshopQueryModel alipayOpenInstantdeliveryMerchantshopQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenInstantdeliveryMerchantshopQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(AlipayOpenInstantdeliveryMerchantshopQueryModel alipayOpenInstantdeliveryMerchantshopQueryModel, final ApiCallback<AlipayOpenInstantdeliveryMerchantshopQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenInstantdeliveryMerchantshopQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayOpenInstantdeliveryMerchantshopQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(AlipayOpenInstantdeliveryMerchantshopQueryModel alipayOpenInstantdeliveryMerchantshopQueryModel, final ApiCallback<AlipayOpenInstantdeliveryMerchantshopQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenInstantdeliveryMerchantshopQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayOpenInstantdeliveryMerchantshopQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
