...
public class AlipayDataBillAccountbookereceiptApi {
     ...
     */
    public okhttp3.Call queryCall(String fileId, String agreementNo, String agreementType, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String fileId, String agreementNo, String agreementType, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(fileId, agreementNo, agreementType, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayDataBillAccountbookereceiptQueryResponseModel query(String fileId, String agreementNo, String agreementType) throws ApiException {
        ApiResponse<AlipayDataBillAccountbookereceiptQueryResponseModel> localVarResp = queryWithHttpInfo(fileId, agreementNo, agreementType, null);
        return localVarResp.getData();
    }

    public AlipayDataBillAccountbookereceiptQueryResponseModel query(String fileId, String agreementNo, String agreementType, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayDataBillAccountbookereceiptQueryResponseModel> localVarResp = queryWithHttpInfo(fileId, agreementNo, agreementType, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayDataBillAccountbookereceiptQueryResponseModel> queryWithHttpInfo(String fileId, String agreementNo, String agreementType, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(fileId, agreementNo, agreementType, null, customizedParams);
        try {
     ...
     */
    @Deprecated
    public okhttp3.Call queryAsync(String fileId, String agreementNo, String agreementType, final ApiCallback<AlipayDataBillAccountbookereceiptQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(fileId, agreementNo, agreementType, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayDataBillAccountbookereceiptQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @Deprecated
    public okhttp3.Call queryAsync(String fileId, String agreementNo, String agreementType, final ApiCallback<AlipayDataBillAccountbookereceiptQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(fileId, agreementNo, agreementType, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayDataBillAccountbookereceiptQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
