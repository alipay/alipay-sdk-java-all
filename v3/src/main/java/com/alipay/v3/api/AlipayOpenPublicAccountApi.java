...
import com.alipay.v3.model.AlipayOpenPublicAccountDeleteModel;
import com.alipay.v3.model.AlipayOpenPublicAccountQueryDefaultResponse;
import com.alipay.v3.model.AlipayOpenPublicAccountQueryModel;
...
public class AlipayOpenPublicAccountApi {
     ...
     * @param alipayOpenPublicAccountDeleteModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call deleteCall(AlipayOpenPublicAccountDeleteModel alipayOpenPublicAccountDeleteModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayOpenPublicAccountDeleteModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteValidateBeforeCall(AlipayOpenPublicAccountDeleteModel alipayOpenPublicAccountDeleteModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = deleteCall(alipayOpenPublicAccountDeleteModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public Object delete(AlipayOpenPublicAccountDeleteModel alipayOpenPublicAccountDeleteModel) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(alipayOpenPublicAccountDeleteModel, null);
        return localVarResp.getData();
    }

    public Object delete(AlipayOpenPublicAccountDeleteModel alipayOpenPublicAccountDeleteModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(alipayOpenPublicAccountDeleteModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteWithHttpInfo(AlipayOpenPublicAccountDeleteModel alipayOpenPublicAccountDeleteModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayOpenPublicAccountDeleteModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call deleteAsync(AlipayOpenPublicAccountDeleteModel alipayOpenPublicAccountDeleteModel, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayOpenPublicAccountDeleteModel, _callback, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call deleteAsync(AlipayOpenPublicAccountDeleteModel alipayOpenPublicAccountDeleteModel, final ApiCallback<Object> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayOpenPublicAccountDeleteModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param alipayOpenPublicAccountQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(AlipayOpenPublicAccountQueryModel alipayOpenPublicAccountQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayOpenPublicAccountQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(AlipayOpenPublicAccountQueryModel alipayOpenPublicAccountQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(alipayOpenPublicAccountQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayOpenPublicAccountQueryResponseModel query(AlipayOpenPublicAccountQueryModel alipayOpenPublicAccountQueryModel) throws ApiException {
        ApiResponse<AlipayOpenPublicAccountQueryResponseModel> localVarResp = queryWithHttpInfo(alipayOpenPublicAccountQueryModel, null);
        return localVarResp.getData();
    }

    public AlipayOpenPublicAccountQueryResponseModel query(AlipayOpenPublicAccountQueryModel alipayOpenPublicAccountQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayOpenPublicAccountQueryResponseModel> localVarResp = queryWithHttpInfo(alipayOpenPublicAccountQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayOpenPublicAccountQueryResponseModel> queryWithHttpInfo(AlipayOpenPublicAccountQueryModel alipayOpenPublicAccountQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenPublicAccountQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(AlipayOpenPublicAccountQueryModel alipayOpenPublicAccountQueryModel, final ApiCallback<AlipayOpenPublicAccountQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenPublicAccountQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayOpenPublicAccountQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(AlipayOpenPublicAccountQueryModel alipayOpenPublicAccountQueryModel, final ApiCallback<AlipayOpenPublicAccountQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenPublicAccountQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayOpenPublicAccountQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
