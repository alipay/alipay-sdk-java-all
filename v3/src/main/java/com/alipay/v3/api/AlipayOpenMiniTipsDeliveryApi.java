...
import com.alipay.v3.model.AlipayOpenMiniTipsDeliveryQueryModel;
...
public class AlipayOpenMiniTipsDeliveryApi {
     ...
     * @param alipayOpenMiniTipsDeliveryQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(AlipayOpenMiniTipsDeliveryQueryModel alipayOpenMiniTipsDeliveryQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayOpenMiniTipsDeliveryQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(AlipayOpenMiniTipsDeliveryQueryModel alipayOpenMiniTipsDeliveryQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(alipayOpenMiniTipsDeliveryQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayOpenMiniTipsDeliveryQueryResponseModel query(AlipayOpenMiniTipsDeliveryQueryModel alipayOpenMiniTipsDeliveryQueryModel) throws ApiException {
        ApiResponse<AlipayOpenMiniTipsDeliveryQueryResponseModel> localVarResp = queryWithHttpInfo(alipayOpenMiniTipsDeliveryQueryModel, null);
        return localVarResp.getData();
    }

    public AlipayOpenMiniTipsDeliveryQueryResponseModel query(AlipayOpenMiniTipsDeliveryQueryModel alipayOpenMiniTipsDeliveryQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayOpenMiniTipsDeliveryQueryResponseModel> localVarResp = queryWithHttpInfo(alipayOpenMiniTipsDeliveryQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayOpenMiniTipsDeliveryQueryResponseModel> queryWithHttpInfo(AlipayOpenMiniTipsDeliveryQueryModel alipayOpenMiniTipsDeliveryQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenMiniTipsDeliveryQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(AlipayOpenMiniTipsDeliveryQueryModel alipayOpenMiniTipsDeliveryQueryModel, final ApiCallback<AlipayOpenMiniTipsDeliveryQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenMiniTipsDeliveryQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayOpenMiniTipsDeliveryQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(AlipayOpenMiniTipsDeliveryQueryModel alipayOpenMiniTipsDeliveryQueryModel, final ApiCallback<AlipayOpenMiniTipsDeliveryQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayOpenMiniTipsDeliveryQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayOpenMiniTipsDeliveryQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
