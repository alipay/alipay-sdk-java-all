...
import com.alipay.v3.model.AlipayEbppBillGetModel;
...
public class AlipayEbppBillApi {
     ...
     * Build call for get
     * @param authToken 用户授权令牌 (optional)
     * @param alipayEbppBillGetModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getCall(String authToken, AlipayEbppBillGetModel alipayEbppBillGetModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayEbppBillGetModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValidateBeforeCall(String authToken, AlipayEbppBillGetModel alipayEbppBillGetModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = getCall(authToken, alipayEbppBillGetModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayEbppBillGetResponseModel get(String authToken, AlipayEbppBillGetModel alipayEbppBillGetModel) throws ApiException {
        ApiResponse<AlipayEbppBillGetResponseModel> localVarResp = getWithHttpInfo(authToken, alipayEbppBillGetModel, null);
        return localVarResp.getData();
    }

    public AlipayEbppBillGetResponseModel get(String authToken, AlipayEbppBillGetModel alipayEbppBillGetModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayEbppBillGetResponseModel> localVarResp = getWithHttpInfo(authToken, alipayEbppBillGetModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayEbppBillGetResponseModel> getWithHttpInfo(String authToken, AlipayEbppBillGetModel alipayEbppBillGetModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(authToken, alipayEbppBillGetModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call getAsync(String authToken, AlipayEbppBillGetModel alipayEbppBillGetModel, final ApiCallback<AlipayEbppBillGetResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValidateBeforeCall(authToken, alipayEbppBillGetModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayEbppBillGetResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call getAsync(String authToken, AlipayEbppBillGetModel alipayEbppBillGetModel, final ApiCallback<AlipayEbppBillGetResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = getValidateBeforeCall(authToken, alipayEbppBillGetModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayEbppBillGetResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
