...
public class AlipayMarketingActivityUserApi {
     ...
     */
    public okhttp3.Call batchqueryvoucherCall(String authToken, String userId, String openId, String activityId, String belongMerchantId, String senderMerchantId, String voucherStatus, Integer pageNum, String merchantAccessMode, Integer pageSize, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
    ...
    private okhttp3.Call batchqueryvoucherValidateBeforeCall(String authToken, String userId, String openId, String activityId, String belongMerchantId, String senderMerchantId, String voucherStatus, Integer pageNum, String merchantAccessMode, Integer pageSize, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = batchqueryvoucherCall(authToken, userId, openId, activityId, belongMerchantId, senderMerchantId, voucherStatus, pageNum, merchantAccessMode, pageSize, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayMarketingActivityUserBatchqueryvoucherResponseModel batchqueryvoucher(String authToken, String userId, String openId, String activityId, String belongMerchantId, String senderMerchantId, String voucherStatus, Integer pageNum, String merchantAccessMode, Integer pageSize) throws ApiException {
        ApiResponse<AlipayMarketingActivityUserBatchqueryvoucherResponseModel> localVarResp = batchqueryvoucherWithHttpInfo(authToken, userId, openId, activityId, belongMerchantId, senderMerchantId, voucherStatus, pageNum, merchantAccessMode, pageSize, null);
        return localVarResp.getData();
    }

    public AlipayMarketingActivityUserBatchqueryvoucherResponseModel batchqueryvoucher(String authToken, String userId, String openId, String activityId, String belongMerchantId, String senderMerchantId, String voucherStatus, Integer pageNum, String merchantAccessMode, Integer pageSize, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayMarketingActivityUserBatchqueryvoucherResponseModel> localVarResp = batchqueryvoucherWithHttpInfo(authToken, userId, openId, activityId, belongMerchantId, senderMerchantId, voucherStatus, pageNum, merchantAccessMode, pageSize, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayMarketingActivityUserBatchqueryvoucherResponseModel> batchqueryvoucherWithHttpInfo(String authToken, String userId, String openId, String activityId, String belongMerchantId, String senderMerchantId, String voucherStatus, Integer pageNum, String merchantAccessMode, Integer pageSize, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = batchqueryvoucherValidateBeforeCall(authToken, userId, openId, activityId, belongMerchantId, senderMerchantId, voucherStatus, pageNum, merchantAccessMode, pageSize, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call batchqueryvoucherAsync(String authToken, String userId, String openId, String activityId, String belongMerchantId, String senderMerchantId, String voucherStatus, Integer pageNum, String merchantAccessMode, Integer pageSize, final ApiCallback<AlipayMarketingActivityUserBatchqueryvoucherResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = batchqueryvoucherValidateBeforeCall(authToken, userId, openId, activityId, belongMerchantId, senderMerchantId, voucherStatus, pageNum, merchantAccessMode, pageSize, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayMarketingActivityUserBatchqueryvoucherResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call batchqueryvoucherAsync(String authToken, String userId, String openId, String activityId, String belongMerchantId, String senderMerchantId, String voucherStatus, Integer pageNum, String merchantAccessMode, Integer pageSize, final ApiCallback<AlipayMarketingActivityUserBatchqueryvoucherResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = batchqueryvoucherValidateBeforeCall(authToken, userId, openId, activityId, belongMerchantId, senderMerchantId, voucherStatus, pageNum, merchantAccessMode, pageSize, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayMarketingActivityUserBatchqueryvoucherResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
