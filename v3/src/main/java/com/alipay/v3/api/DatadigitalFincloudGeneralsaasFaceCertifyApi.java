...
import com.alipay.v3.model.DatadigitalFincloudGeneralsaasFaceCertifyQueryModel;
...
public class DatadigitalFincloudGeneralsaasFaceCertifyApi {
     ...
     * @param datadigitalFincloudGeneralsaasFaceCertifyQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(DatadigitalFincloudGeneralsaasFaceCertifyQueryModel datadigitalFincloudGeneralsaasFaceCertifyQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : datadigitalFincloudGeneralsaasFaceCertifyQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(DatadigitalFincloudGeneralsaasFaceCertifyQueryModel datadigitalFincloudGeneralsaasFaceCertifyQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(datadigitalFincloudGeneralsaasFaceCertifyQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel query(DatadigitalFincloudGeneralsaasFaceCertifyQueryModel datadigitalFincloudGeneralsaasFaceCertifyQueryModel) throws ApiException {
        ApiResponse<DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel> localVarResp = queryWithHttpInfo(datadigitalFincloudGeneralsaasFaceCertifyQueryModel, null);
        return localVarResp.getData();
    }

    public DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel query(DatadigitalFincloudGeneralsaasFaceCertifyQueryModel datadigitalFincloudGeneralsaasFaceCertifyQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel> localVarResp = queryWithHttpInfo(datadigitalFincloudGeneralsaasFaceCertifyQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel> queryWithHttpInfo(DatadigitalFincloudGeneralsaasFaceCertifyQueryModel datadigitalFincloudGeneralsaasFaceCertifyQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(datadigitalFincloudGeneralsaasFaceCertifyQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(DatadigitalFincloudGeneralsaasFaceCertifyQueryModel datadigitalFincloudGeneralsaasFaceCertifyQueryModel, final ApiCallback<DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(datadigitalFincloudGeneralsaasFaceCertifyQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(DatadigitalFincloudGeneralsaasFaceCertifyQueryModel datadigitalFincloudGeneralsaasFaceCertifyQueryModel, final ApiCallback<DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(datadigitalFincloudGeneralsaasFaceCertifyQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<DatadigitalFincloudGeneralsaasFaceCertifyQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
