...
import com.alipay.v3.model.AlipayIserviceCcmSwLibraryBatchqueryModel;
...
import com.alipay.v3.model.AlipayIserviceCcmSwLibraryDeleteModel;
...
public class AlipayIserviceCcmSwLibraryApi {
     ...
     * @param alipayIserviceCcmSwLibraryBatchqueryModel  (optional)
     ...
     */
    public okhttp3.Call batchqueryCall(AlipayIserviceCcmSwLibraryBatchqueryModel alipayIserviceCcmSwLibraryBatchqueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayIserviceCcmSwLibraryBatchqueryModel;
    ...
    private okhttp3.Call batchqueryValidateBeforeCall(AlipayIserviceCcmSwLibraryBatchqueryModel alipayIserviceCcmSwLibraryBatchqueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = batchqueryCall(alipayIserviceCcmSwLibraryBatchqueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayIserviceCcmSwLibraryBatchqueryResponseModel batchquery(AlipayIserviceCcmSwLibraryBatchqueryModel alipayIserviceCcmSwLibraryBatchqueryModel) throws ApiException {
        ApiResponse<AlipayIserviceCcmSwLibraryBatchqueryResponseModel> localVarResp = batchqueryWithHttpInfo(alipayIserviceCcmSwLibraryBatchqueryModel, null);
        return localVarResp.getData();
    }

    public AlipayIserviceCcmSwLibraryBatchqueryResponseModel batchquery(AlipayIserviceCcmSwLibraryBatchqueryModel alipayIserviceCcmSwLibraryBatchqueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayIserviceCcmSwLibraryBatchqueryResponseModel> localVarResp = batchqueryWithHttpInfo(alipayIserviceCcmSwLibraryBatchqueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayIserviceCcmSwLibraryBatchqueryResponseModel> batchqueryWithHttpInfo(AlipayIserviceCcmSwLibraryBatchqueryModel alipayIserviceCcmSwLibraryBatchqueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = batchqueryValidateBeforeCall(alipayIserviceCcmSwLibraryBatchqueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call batchqueryAsync(AlipayIserviceCcmSwLibraryBatchqueryModel alipayIserviceCcmSwLibraryBatchqueryModel, final ApiCallback<AlipayIserviceCcmSwLibraryBatchqueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = batchqueryValidateBeforeCall(alipayIserviceCcmSwLibraryBatchqueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayIserviceCcmSwLibraryBatchqueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call batchqueryAsync(AlipayIserviceCcmSwLibraryBatchqueryModel alipayIserviceCcmSwLibraryBatchqueryModel, final ApiCallback<AlipayIserviceCcmSwLibraryBatchqueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = batchqueryValidateBeforeCall(alipayIserviceCcmSwLibraryBatchqueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayIserviceCcmSwLibraryBatchqueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param alipayIserviceCcmSwLibraryDeleteModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call deleteCall(AlipayIserviceCcmSwLibraryDeleteModel alipayIserviceCcmSwLibraryDeleteModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayIserviceCcmSwLibraryDeleteModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteValidateBeforeCall(AlipayIserviceCcmSwLibraryDeleteModel alipayIserviceCcmSwLibraryDeleteModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = deleteCall(alipayIserviceCcmSwLibraryDeleteModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public Object delete(AlipayIserviceCcmSwLibraryDeleteModel alipayIserviceCcmSwLibraryDeleteModel) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(alipayIserviceCcmSwLibraryDeleteModel, null);
        return localVarResp.getData();
    }

    public Object delete(AlipayIserviceCcmSwLibraryDeleteModel alipayIserviceCcmSwLibraryDeleteModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(alipayIserviceCcmSwLibraryDeleteModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteWithHttpInfo(AlipayIserviceCcmSwLibraryDeleteModel alipayIserviceCcmSwLibraryDeleteModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayIserviceCcmSwLibraryDeleteModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call deleteAsync(AlipayIserviceCcmSwLibraryDeleteModel alipayIserviceCcmSwLibraryDeleteModel, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayIserviceCcmSwLibraryDeleteModel, _callback, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call deleteAsync(AlipayIserviceCcmSwLibraryDeleteModel alipayIserviceCcmSwLibraryDeleteModel, final ApiCallback<Object> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayIserviceCcmSwLibraryDeleteModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
