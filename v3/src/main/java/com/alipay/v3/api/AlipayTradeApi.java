...
public class AlipayTradeApi {
     ...
     * @param outTradeNo 订单支付时传入的商户订单号,和支付宝交易号不能同时为空。  trade_no,out_trade_no如果同时存在优先取trade_no (optional)
     * @param tradeNo 支付宝交易号，和商户订单号不能同时为空 (optional)
     * @param orgPid 银行间联模式下有用，其它场景请不要使用；  双联通过该参数指定需要查询的交易所属收单机构的pid; (optional)
     * @param queryOptions 查询选项，商户传入该参数可定制本接口同步响应额外返回的信息字段，数组格式。支持枚举如下：trade_settle_info：返回的交易结算信息，包含分账、补差等信息； fund_bill_list：交易支付使用的资金渠道； voucher_detail_list：交易支付时使用的所有优惠券信息； discount_goods_detail：交易支付所使用的单品券优惠的商品优惠信息； mdiscount_amount：商家优惠金额； (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(String outTradeNo, String tradeNo, String orgPid, List<String> queryOptions, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (orgPid != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("org_pid", orgPid));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String outTradeNo, String tradeNo, String orgPid, List<String> queryOptions, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(outTradeNo, tradeNo, orgPid, queryOptions, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayTradeQueryResponseModel query(String outTradeNo, String tradeNo, String orgPid, List<String> queryOptions) throws ApiException {
        ApiResponse<AlipayTradeQueryResponseModel> localVarResp = queryWithHttpInfo(outTradeNo, tradeNo, orgPid, queryOptions, null);
        return localVarResp.getData();
    }

    public AlipayTradeQueryResponseModel query(String outTradeNo, String tradeNo, String orgPid, List<String> queryOptions, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayTradeQueryResponseModel> localVarResp = queryWithHttpInfo(outTradeNo, tradeNo, orgPid, queryOptions, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayTradeQueryResponseModel> queryWithHttpInfo(String outTradeNo, String tradeNo, String orgPid, List<String> queryOptions, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(outTradeNo, tradeNo, orgPid, queryOptions, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(String outTradeNo, String tradeNo, String orgPid, List<String> queryOptions, final ApiCallback<AlipayTradeQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(outTradeNo, tradeNo, orgPid, queryOptions, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayTradeQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(String outTradeNo, String tradeNo, String orgPid, List<String> queryOptions, final ApiCallback<AlipayTradeQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(outTradeNo, tradeNo, orgPid, queryOptions, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayTradeQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
