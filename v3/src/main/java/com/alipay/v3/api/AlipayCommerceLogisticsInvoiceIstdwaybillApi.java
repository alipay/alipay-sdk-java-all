...
import com.alipay.v3.model.AlipayCommerceLogisticsInvoiceIstdwaybillQueryModel;
...
public class AlipayCommerceLogisticsInvoiceIstdwaybillApi {
     ...
     * @param alipayCommerceLogisticsInvoiceIstdwaybillQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(AlipayCommerceLogisticsInvoiceIstdwaybillQueryModel alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayCommerceLogisticsInvoiceIstdwaybillQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(AlipayCommerceLogisticsInvoiceIstdwaybillQueryModel alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel query(AlipayCommerceLogisticsInvoiceIstdwaybillQueryModel alipayCommerceLogisticsInvoiceIstdwaybillQueryModel) throws ApiException {
        ApiResponse<AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel> localVarResp = queryWithHttpInfo(alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, null);
        return localVarResp.getData();
    }

    public AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel query(AlipayCommerceLogisticsInvoiceIstdwaybillQueryModel alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel> localVarResp = queryWithHttpInfo(alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel> queryWithHttpInfo(AlipayCommerceLogisticsInvoiceIstdwaybillQueryModel alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(AlipayCommerceLogisticsInvoiceIstdwaybillQueryModel alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, final ApiCallback<AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(AlipayCommerceLogisticsInvoiceIstdwaybillQueryModel alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, final ApiCallback<AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayCommerceLogisticsInvoiceIstdwaybillQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayCommerceLogisticsInvoiceIstdwaybillQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
