...
public class ZhimaCreditPayafteruseCreditagreementApi {
     ...
     * @param productCode 当产品是芝麻守约时必填，需传入CREDIT_AGREEMENT (optional)
     * @param serviceId 芝麻信用服务id，上线前提前分配给商户 (optional)
     * @param extraParam 扩展参数 (optional)
     ...
     */
    public okhttp3.Call queryCall(String outAgreementNo, String creditAgreementId, String productCode, String serviceId, String extraParam, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        ...
        if (extraParam != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("extra_param", extraParam));
        }
    ...
    private okhttp3.Call queryValidateBeforeCall(String outAgreementNo, String creditAgreementId, String productCode, String serviceId, String extraParam, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(outAgreementNo, creditAgreementId, productCode, serviceId, extraParam, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public ZhimaCreditPayafteruseCreditagreementQueryResponseModel query(String outAgreementNo, String creditAgreementId, String productCode, String serviceId, String extraParam) throws ApiException {
        ApiResponse<ZhimaCreditPayafteruseCreditagreementQueryResponseModel> localVarResp = queryWithHttpInfo(outAgreementNo, creditAgreementId, productCode, serviceId, extraParam, null);
        return localVarResp.getData();
    }

    public ZhimaCreditPayafteruseCreditagreementQueryResponseModel query(String outAgreementNo, String creditAgreementId, String productCode, String serviceId, String extraParam, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<ZhimaCreditPayafteruseCreditagreementQueryResponseModel> localVarResp = queryWithHttpInfo(outAgreementNo, creditAgreementId, productCode, serviceId, extraParam, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ZhimaCreditPayafteruseCreditagreementQueryResponseModel> queryWithHttpInfo(String outAgreementNo, String creditAgreementId, String productCode, String serviceId, String extraParam, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(outAgreementNo, creditAgreementId, productCode, serviceId, extraParam, null, customizedParams);
        try {
     ...
     */
    @Deprecated
    public okhttp3.Call queryAsync(String outAgreementNo, String creditAgreementId, String productCode, String serviceId, String extraParam, final ApiCallback<ZhimaCreditPayafteruseCreditagreementQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(outAgreementNo, creditAgreementId, productCode, serviceId, extraParam, _callback, null);
        Type localVarReturnType = new TypeToken<ZhimaCreditPayafteruseCreditagreementQueryResponseModel>(){}.getType();
    ...
    @Deprecated
    public okhttp3.Call queryAsync(String outAgreementNo, String creditAgreementId, String productCode, String serviceId, String extraParam, final ApiCallback<ZhimaCreditPayafteruseCreditagreementQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(outAgreementNo, creditAgreementId, productCode, serviceId, extraParam, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<ZhimaCreditPayafteruseCreditagreementQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
