...
import com.alipay.v3.model.AlipayEbppInvoiceExpenserulesSceneruleQueryModel;
...
public class AlipayEbppInvoiceExpenserulesSceneruleApi {
     ...
     * @param alipayEbppInvoiceExpenserulesSceneruleQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(AlipayEbppInvoiceExpenserulesSceneruleQueryModel alipayEbppInvoiceExpenserulesSceneruleQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayEbppInvoiceExpenserulesSceneruleQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(AlipayEbppInvoiceExpenserulesSceneruleQueryModel alipayEbppInvoiceExpenserulesSceneruleQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(alipayEbppInvoiceExpenserulesSceneruleQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel query(AlipayEbppInvoiceExpenserulesSceneruleQueryModel alipayEbppInvoiceExpenserulesSceneruleQueryModel) throws ApiException {
        ApiResponse<AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel> localVarResp = queryWithHttpInfo(alipayEbppInvoiceExpenserulesSceneruleQueryModel, null);
        return localVarResp.getData();
    }

    public AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel query(AlipayEbppInvoiceExpenserulesSceneruleQueryModel alipayEbppInvoiceExpenserulesSceneruleQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel> localVarResp = queryWithHttpInfo(alipayEbppInvoiceExpenserulesSceneruleQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel> queryWithHttpInfo(AlipayEbppInvoiceExpenserulesSceneruleQueryModel alipayEbppInvoiceExpenserulesSceneruleQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayEbppInvoiceExpenserulesSceneruleQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(AlipayEbppInvoiceExpenserulesSceneruleQueryModel alipayEbppInvoiceExpenserulesSceneruleQueryModel, final ApiCallback<AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayEbppInvoiceExpenserulesSceneruleQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(AlipayEbppInvoiceExpenserulesSceneruleQueryModel alipayEbppInvoiceExpenserulesSceneruleQueryModel, final ApiCallback<AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayEbppInvoiceExpenserulesSceneruleQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayEbppInvoiceExpenserulesSceneruleQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
