...
public class AlipayDataDataserviceAdPromotepageApi {
     ...
     */
    public okhttp3.Call downloadCall(String bizToken, String principalTag, Integer promotePageId, String startDate, String endDate, Integer pageNo, Integer pageSize, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call downloadValidateBeforeCall(String bizToken, String principalTag, Integer promotePageId, String startDate, String endDate, Integer pageNo, Integer pageSize, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = downloadCall(bizToken, principalTag, promotePageId, startDate, endDate, pageNo, pageSize, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayDataDataserviceAdPromotepageDownloadResponseModel download(String bizToken, String principalTag, Integer promotePageId, String startDate, String endDate, Integer pageNo, Integer pageSize) throws ApiException {
        ApiResponse<AlipayDataDataserviceAdPromotepageDownloadResponseModel> localVarResp = downloadWithHttpInfo(bizToken, principalTag, promotePageId, startDate, endDate, pageNo, pageSize, null);
        return localVarResp.getData();
    }

    public AlipayDataDataserviceAdPromotepageDownloadResponseModel download(String bizToken, String principalTag, Integer promotePageId, String startDate, String endDate, Integer pageNo, Integer pageSize, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayDataDataserviceAdPromotepageDownloadResponseModel> localVarResp = downloadWithHttpInfo(bizToken, principalTag, promotePageId, startDate, endDate, pageNo, pageSize, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayDataDataserviceAdPromotepageDownloadResponseModel> downloadWithHttpInfo(String bizToken, String principalTag, Integer promotePageId, String startDate, String endDate, Integer pageNo, Integer pageSize, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = downloadValidateBeforeCall(bizToken, principalTag, promotePageId, startDate, endDate, pageNo, pageSize, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call downloadAsync(String bizToken, String principalTag, Integer promotePageId, String startDate, String endDate, Integer pageNo, Integer pageSize, final ApiCallback<AlipayDataDataserviceAdPromotepageDownloadResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = downloadValidateBeforeCall(bizToken, principalTag, promotePageId, startDate, endDate, pageNo, pageSize, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayDataDataserviceAdPromotepageDownloadResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call downloadAsync(String bizToken, String principalTag, Integer promotePageId, String startDate, String endDate, Integer pageNo, Integer pageSize, final ApiCallback<AlipayDataDataserviceAdPromotepageDownloadResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = downloadValidateBeforeCall(bizToken, principalTag, promotePageId, startDate, endDate, pageNo, pageSize, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayDataDataserviceAdPromotepageDownloadResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
