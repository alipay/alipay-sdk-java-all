...
import com.alipay.v3.model.DatadigitalFincloudGeneralsaasFaceCheckQueryModel;
...
public class DatadigitalFincloudGeneralsaasFaceCheckApi {
     ...
     * @param datadigitalFincloudGeneralsaasFaceCheckQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(DatadigitalFincloudGeneralsaasFaceCheckQueryModel datadigitalFincloudGeneralsaasFaceCheckQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : datadigitalFincloudGeneralsaasFaceCheckQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(DatadigitalFincloudGeneralsaasFaceCheckQueryModel datadigitalFincloudGeneralsaasFaceCheckQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(datadigitalFincloudGeneralsaasFaceCheckQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel query(DatadigitalFincloudGeneralsaasFaceCheckQueryModel datadigitalFincloudGeneralsaasFaceCheckQueryModel) throws ApiException {
        ApiResponse<DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel> localVarResp = queryWithHttpInfo(datadigitalFincloudGeneralsaasFaceCheckQueryModel, null);
        return localVarResp.getData();
    }

    public DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel query(DatadigitalFincloudGeneralsaasFaceCheckQueryModel datadigitalFincloudGeneralsaasFaceCheckQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel> localVarResp = queryWithHttpInfo(datadigitalFincloudGeneralsaasFaceCheckQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel> queryWithHttpInfo(DatadigitalFincloudGeneralsaasFaceCheckQueryModel datadigitalFincloudGeneralsaasFaceCheckQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(datadigitalFincloudGeneralsaasFaceCheckQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(DatadigitalFincloudGeneralsaasFaceCheckQueryModel datadigitalFincloudGeneralsaasFaceCheckQueryModel, final ApiCallback<DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(datadigitalFincloudGeneralsaasFaceCheckQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(DatadigitalFincloudGeneralsaasFaceCheckQueryModel datadigitalFincloudGeneralsaasFaceCheckQueryModel, final ApiCallback<DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(datadigitalFincloudGeneralsaasFaceCheckQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<DatadigitalFincloudGeneralsaasFaceCheckQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
