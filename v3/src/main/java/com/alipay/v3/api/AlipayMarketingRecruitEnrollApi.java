...
import com.alipay.v3.model.AlipayMarketingRecruitEnrollQueryModel;
...
public class AlipayMarketingRecruitEnrollApi {
     ...
     * @param qi 111 (required)
     * @param ass 1 (optional)
     * @param alipayMarketingRecruitEnrollQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(String qi, String ass, AlipayMarketingRecruitEnrollQueryModel alipayMarketingRecruitEnrollQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayMarketingRecruitEnrollQueryModel;

        // create path and map variables
        String localVarPath = "/v3/alipay/marketing/recruit/enroll/{qi}"
            .replaceAll("\\{" + "qi" + "\\}", localVarApiClient.escapeString(qi.toString()));
        ...
        if (ass != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ass", ass));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String qi, String ass, AlipayMarketingRecruitEnrollQueryModel alipayMarketingRecruitEnrollQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        
        // verify the required parameter 'qi' is set
        if (qi == null) {
            throw new ApiException("Missing the required parameter 'qi' when calling query(Async)");
        }
        

        okhttp3.Call localVarCall = queryCall(qi, ass, alipayMarketingRecruitEnrollQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayMarketingRecruitEnrollQueryResponseModel query(String qi, String ass, AlipayMarketingRecruitEnrollQueryModel alipayMarketingRecruitEnrollQueryModel) throws ApiException {
        ApiResponse<AlipayMarketingRecruitEnrollQueryResponseModel> localVarResp = queryWithHttpInfo(qi, ass, alipayMarketingRecruitEnrollQueryModel, null);
        return localVarResp.getData();
    }

    public AlipayMarketingRecruitEnrollQueryResponseModel query(String qi, String ass, AlipayMarketingRecruitEnrollQueryModel alipayMarketingRecruitEnrollQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayMarketingRecruitEnrollQueryResponseModel> localVarResp = queryWithHttpInfo(qi, ass, alipayMarketingRecruitEnrollQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayMarketingRecruitEnrollQueryResponseModel> queryWithHttpInfo(String qi, String ass, AlipayMarketingRecruitEnrollQueryModel alipayMarketingRecruitEnrollQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(qi, ass, alipayMarketingRecruitEnrollQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(String qi, String ass, AlipayMarketingRecruitEnrollQueryModel alipayMarketingRecruitEnrollQueryModel, final ApiCallback<AlipayMarketingRecruitEnrollQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(qi, ass, alipayMarketingRecruitEnrollQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayMarketingRecruitEnrollQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(String qi, String ass, AlipayMarketingRecruitEnrollQueryModel alipayMarketingRecruitEnrollQueryModel, final ApiCallback<AlipayMarketingRecruitEnrollQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(qi, ass, alipayMarketingRecruitEnrollQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayMarketingRecruitEnrollQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
