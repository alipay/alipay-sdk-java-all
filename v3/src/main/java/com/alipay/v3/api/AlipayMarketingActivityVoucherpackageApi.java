...
import com.alipay.v3.model.AlipayMarketingActivityVoucherpackageQueryModel;
...
public class AlipayMarketingActivityVoucherpackageApi {
     ...
     * @param alipayMarketingActivityVoucherpackageQueryModel  (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(AlipayMarketingActivityVoucherpackageQueryModel alipayMarketingActivityVoucherpackageQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayMarketingActivityVoucherpackageQueryModel;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(AlipayMarketingActivityVoucherpackageQueryModel alipayMarketingActivityVoucherpackageQueryModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(alipayMarketingActivityVoucherpackageQueryModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayMarketingActivityVoucherpackageQueryResponseModel query(AlipayMarketingActivityVoucherpackageQueryModel alipayMarketingActivityVoucherpackageQueryModel) throws ApiException {
        ApiResponse<AlipayMarketingActivityVoucherpackageQueryResponseModel> localVarResp = queryWithHttpInfo(alipayMarketingActivityVoucherpackageQueryModel, null);
        return localVarResp.getData();
    }

    public AlipayMarketingActivityVoucherpackageQueryResponseModel query(AlipayMarketingActivityVoucherpackageQueryModel alipayMarketingActivityVoucherpackageQueryModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayMarketingActivityVoucherpackageQueryResponseModel> localVarResp = queryWithHttpInfo(alipayMarketingActivityVoucherpackageQueryModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayMarketingActivityVoucherpackageQueryResponseModel> queryWithHttpInfo(AlipayMarketingActivityVoucherpackageQueryModel alipayMarketingActivityVoucherpackageQueryModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayMarketingActivityVoucherpackageQueryModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call queryAsync(AlipayMarketingActivityVoucherpackageQueryModel alipayMarketingActivityVoucherpackageQueryModel, final ApiCallback<AlipayMarketingActivityVoucherpackageQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayMarketingActivityVoucherpackageQueryModel, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayMarketingActivityVoucherpackageQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call queryAsync(AlipayMarketingActivityVoucherpackageQueryModel alipayMarketingActivityVoucherpackageQueryModel, final ApiCallback<AlipayMarketingActivityVoucherpackageQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(alipayMarketingActivityVoucherpackageQueryModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayMarketingActivityVoucherpackageQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
