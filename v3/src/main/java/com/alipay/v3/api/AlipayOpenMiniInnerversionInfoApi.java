...
import com.alipay.v3.model.AlipayOpenMiniInnerversionInfoDeleteModel;
...
public class AlipayOpenMiniInnerversionInfoApi {
     ...
     * @param alipayOpenMiniInnerversionInfoDeleteModel  (optional)
     ...
     */
    public okhttp3.Call deleteCall(AlipayOpenMiniInnerversionInfoDeleteModel alipayOpenMiniInnerversionInfoDeleteModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        ...
        Object localVarPostBody = (customizedParams != null && !Strings.isNullOrEmpty(customizedParams.getBodyContent()))
                ? customizedParams.getBodyContent() : alipayOpenMiniInnerversionInfoDeleteModel;
    ...
    private okhttp3.Call deleteValidateBeforeCall(AlipayOpenMiniInnerversionInfoDeleteModel alipayOpenMiniInnerversionInfoDeleteModel, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = deleteCall(alipayOpenMiniInnerversionInfoDeleteModel, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public Object delete(AlipayOpenMiniInnerversionInfoDeleteModel alipayOpenMiniInnerversionInfoDeleteModel) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(alipayOpenMiniInnerversionInfoDeleteModel, null);
        return localVarResp.getData();
    }

    public Object delete(AlipayOpenMiniInnerversionInfoDeleteModel alipayOpenMiniInnerversionInfoDeleteModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<Object> localVarResp = deleteWithHttpInfo(alipayOpenMiniInnerversionInfoDeleteModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteWithHttpInfo(AlipayOpenMiniInnerversionInfoDeleteModel alipayOpenMiniInnerversionInfoDeleteModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayOpenMiniInnerversionInfoDeleteModel, null, customizedParams);
        try {
     ...
     */
    public okhttp3.Call deleteAsync(AlipayOpenMiniInnerversionInfoDeleteModel alipayOpenMiniInnerversionInfoDeleteModel, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayOpenMiniInnerversionInfoDeleteModel, _callback, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public okhttp3.Call deleteAsync(AlipayOpenMiniInnerversionInfoDeleteModel alipayOpenMiniInnerversionInfoDeleteModel, final ApiCallback<Object> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayOpenMiniInnerversionInfoDeleteModel, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
